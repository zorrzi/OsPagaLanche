...
| Tiles, fundos de caverna, objetos e sprites de monstro usados na ambientação de caverna | `Assets/Art/Objects/Cave/Cave Platformer Tileset/`, `Assets/Art/Backgrounds/Cave/`, `Assets/Art/Tilesets/Cave/` | Unity Asset Store — pacote **2D Platform Tile Set - Cave** *(os metadados locais trazem o nome com um erro de grafia)* (`productId: 61672`, `packageVersion: 1.2`) | **[lacuna: autor/publicador não aparece nos arquivos versionados]** | **Unity Asset Store EULA** / `licenseType: Store` |
